      ...
      <div className="space-y-6 justify-between text-gray-600 md:flex md:flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
        ...
        <div className="md:7/12 lg:w-1/2">
          <h2 className="text-3xl font-bold text-gray-900 md:text-4xl dark:text-white">
            St Micheal Church Events 
          </h2>
          <p className="my-8 text-gray-600 dark:text-gray-300">
            In the fast-paced world we live in, finding moments of peace, safety, and blessings can be a real challenge. However, there is a sanctuary that offers all of these and more - Saint Michael's. 
           <br/> <br /> you should have made it a habit to attend our Sunday gatherings for Safety in Faith, Blessing Abound, Community and connection.
          </p>
          <div className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
            <div className="mt-8 flex gap-4 md:items-center">
              ...
              <div className="w-5/6">
                ...
                <p className="text-gray-500 dark:text-gray-400">message us for any burden you have</p>
              </div> 
            </div> 
